...
/**
 * The ONE product edit screen, shared by /admin/products/[id] and
 * /panel/produse/[id] — a single form, two doors. `back` and `basePath`
 * keep navigation inside whichever section the operator came from.
 */
export async function ProductEditScreen({
  locale,
  id,
  back,
  basePath,
  ...
  return (
    <div className="px-4 py-8 md:px-8 md:py-10">
      <AdminPageHeader
        ...
        back={{
          href: back.href as "/admin/products",
          label: back.label ?? t("nav_products"),
          locale,
        }}
      />
