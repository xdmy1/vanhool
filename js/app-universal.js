...
const TRANSLATIONS = {
    en: {
        ...
        simplified_process_info: "Simplified process: Fill in your details and choose a payment method.",
        ...
        checkout_phone_placeholder: "6X XXX XXX",
        checkout_country_code: "Country Code",
        payment_method_title: "Payment Method",
        payment_cash: "Cash on Delivery",
        payment_cash_desc: "Pay with cash upon product delivery",
        payment_transfer: "Bank Transfer",
        payment_transfer_desc: "You will receive an invoice by email for payment",
        accept_terms_label: "I agree to the order terms and conditions *",
        thankyou_transfer_title: "Invoice sent!",
        thankyou_transfer_desc: "An invoice has been sent to your email. Please complete the payment and contact us for confirmation.",
        thankyou_cash_title: "Order confirmed!",
        thankyou_cash_desc: "Your order is confirmed. We will contact you soon to arrange delivery and payment.",
        invoice_sending: "Sending invoice...",
        invoice_sent: "Invoice sent successfully",
        invoice_failed: "Could not send invoice, but your order is saved",
    ...
    ro: {
        ...
        simplified_process_info: "Proces simplificat: Completați datele și alegeți metoda de plată.",
        ...
        checkout_email: "Email *",
        checkout_email_placeholder: "email@exemplu.com",
        checkout_phone_placeholder: "6X XXX XXX",
        checkout_country_code: "Prefix țară",
        payment_method_title: "Metoda de Plată",
        payment_cash: "Plata la Livrare (Ramburs)",
        payment_cash_desc: "Plătiți cu bani cash la primirea produselor",
        payment_transfer: "Transfer Bancar",
        payment_transfer_desc: "Veți primi o factură pe email pentru plată",
        accept_terms_label: "Sunt de acord cu termenii și condițiile comenzii *",
        thankyou_transfer_title: "Factură trimisă!",
        thankyou_transfer_desc: "O factură a fost trimisă pe emailul dumneavoastră. Vă rugăm să efectuați plata și să ne contactați pentru confirmare.",
        thankyou_cash_title: "Comandă confirmată!",
        thankyou_cash_desc: "Comanda dumneavoastră este confirmată. Vă vom contacta în curând pentru a aranja livrarea și plata.",
        invoice_sending: "Se trimite factura...",
        invoice_sent: "Factură trimisă cu succes",
        invoice_failed: "Nu s-a putut trimite factura, dar comanda este salvată",
    ...
    ru: {
        ...
        simplified_process_info: "Упрощённый процесс: Заполните данные и выберите способ оплаты.",
        ...
        checkout_email: "Email *",
        checkout_email_placeholder: "email@primer.com",
        checkout_phone_placeholder: "6X XXX XXX",
        checkout_country_code: "Код страны",
        payment_method_title: "Способ оплаты",
        payment_cash: "Оплата при доставке (наложенный платёж)",
        payment_cash_desc: "Оплата наличными при получении товара",
        payment_transfer: "Банковский перевод",
        payment_transfer_desc: "Вы получите счёт на email для оплаты",
        accept_terms_label: "Я согласен с условиями заказа *",
        thankyou_transfer_title: "Счёт отправлен!",
        thankyou_transfer_desc: "Счёт был отправлен на вашу электронную почту. Пожалуйста, оплатите и свяжитесь с нами для подтверждения.",
        thankyou_cash_title: "Заказ подтверждён!",
        thankyou_cash_desc: "Ваш заказ подтверждён. Мы свяжемся с вами в ближайшее время для организации доставки и оплаты.",
        invoice_sending: "Отправка счёта...",
        invoice_sent: "Счёт успешно отправлен",
        invoice_failed: "Не удалось отправить счёт, но ваш заказ сохранён",
