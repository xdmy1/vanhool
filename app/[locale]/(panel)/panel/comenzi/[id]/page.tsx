// Panel clone of /admin/orders/[id] — back button + delete redirect
// point at /panel/comenzi so the operator never bounces into the admin
// layout when working with orders out of the panel.
...
export default async function PanelComandaDetailPage({
  params,
}: {
  ...
  return (
    <div className="px-4 py-8 md:px-8 md:py-10">
      <AdminPageHeader
        ...
        back={{ href: "/panel/comenzi", label: t("order_detail_back"), locale }}
        actions={
          <div className="flex items-center gap-2">
            ...
            <PinDeleteButton
              ...
              entityId={order.id}
              redirectTo={`/${locale}/panel/comenzi`}
            />
          </div>
        }
      />
