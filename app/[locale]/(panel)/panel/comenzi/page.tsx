// Panel clone of /admin/orders — same data, same widgets, but every
// internal link points back into /panel/comenzi so the operator stays
// inside the panel layout. Original admin route remains live; this is
// the path the panel sidebar uses.
...
export default async function PanelComenziPage({
  params,
  searchParams,
}: {
