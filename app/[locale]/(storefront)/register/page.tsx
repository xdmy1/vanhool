    ...
    >
      <RegisterForm
        labels={{
          ...
          countryMd: t("country_md"),
          countryRo: t("country_ro"),
          countryOther: t("country_other"),
          phonePlaceholder: t("phone_placeholder"),
          contactPositionPlaceholder: t("contact_position_placeholder"),
          companyNamePlaceholder: t("company_name_placeholder"),
          idnoPlaceholder: t("idno_placeholder"),
          legalFormPlaceholder: t("legal_form_placeholder"),
          streetPlaceholder: t("street_placeholder"),
          cityPlaceholder: t("city_placeholder"),
          districtPlaceholder: t("district_placeholder"),
          postalPlaceholder: t("postal_placeholder"),
          vatNumberPlaceholder: t("vat_number_placeholder"),
          euVatIdPlaceholder: t("eu_vat_id_placeholder"),
          ...
          errorPasswordTooShort: t("error_password_too_short"),
          errorTermsRequired: t("error_terms_required"),
          errorFillRequired: t("error_fill_required"),
